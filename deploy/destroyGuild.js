...
if (!token || !clientId) {
	...
	console.log('\nUsage:');
	console.log('  node deploy/destroyGuild.js <botname>           - Delete guild commands');
	console.log('  node deploy/destroyGuild.js <botname> --global  - Delete global commands');
...
(async () => {
	...
	if (!process.argv.includes("--global")) {
		rl.question(
			...
			async (guild) => {
				console.log(`Evil bot has been started to delete ${botName}'s guild commands...`);
				await rest
		...
		console.log(`Evil bot has been started to delete ${botName}'s global commands...`);
		await rest
